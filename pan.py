...
def pan():
    ...
    print("/_/      (_)  /_/  |_|  (_)  /_/ |_/   ")
    print("   ")
    print("Pan A.I. by Alvin Herbert (c) 2022")
    print("   ")
...
def GreetUser():
    ...
    if (hr <= 1) and (hr <= 12):
        ...
        Day()
        Date()
        Speak("All systems are online and ready Sir!")
...
def SystemInfo():
    ...
    final_res = f"Currently we're running at#battery_percent = psutil.sensors_battery().percent {cpu_stats} percent of CPU power, {memory_in_use} of RAM out of total {total_memory}"
    Speak(final_res)
...
def TaskExe():
    ...
    def Dict():
        if 'meaning' in query:
            word = str(query).replace("what","").replace("is","").replace("the","").replace("meaning", "").replace("of", "").replace("Pan", "")
            meaning = Diction.meaning(word)
            Speak(f"The meaning of {word} is {meaning}")
        
        elif 'synonym' in query:
            word = str(query).replace("what","").replace("is","").replace("the","").replace("synonym", "").replace("of", "").replace("Pan", "")
            synonym = Diction.synonym(word)
            Speak(f"The synonym of {word} is {synonym}")
        
        elif 'antonym' in query:
            word = str(query).replace("what","").replace("is","").replace("the","").replace("antonym", "").replace("of", "").replace("Pan", "")
    ...
    while True:
        ...
        query = takecommand()
        #Pan greetings
        if 'hello' in query and 'pan' in query:
            ...
            Speak("Allow me to introduce myself, I am Pan!")
        
        elif 'back' in query and 'pan' in query:
            playsound(aiVoices + "ai_greeting_welcome-home.mp3")
        
        #Pan shutdown
        elif 'take a break' in query and 'pan' in query:
            playsound(aiVoices + "Jarvis-Goodbye.mp3")
            break

        elif 'bye' in query and 'pan' in query:
            playsound(aiVoices + "Jarvis-Goodbye.mp3")
            break

        elif 'shut down' in query and 'pan' in query:
            playsound(aiVoices + "Jarvis-Goodbye.mp3")
            break

        elif 'shutdown' in query and 'pan' in query:
            playsound(aiVoices + "Jarvis-Goodbye.mp3")
            break

        elif 'goodnight' in query and 'pan' in query:
            playsound(aiVoices + "ai_bye_goodnight.mp3")
            break

        elif 'offline' in query and 'pan' in query:
        ...
        #Pan searching
        elif 'youtube' in query and 'pan' in query:
            Search()
        
        elif 'amazon' in query and 'pan' in query:
            Search()
        
        elif 'etsy' in query and 'pan' in query:
            Search()

        elif 'search google' in query and 'pan' in query:
            query = query.replace("pan", "")
        ...
        elif 'open website' in query and 'pan' in query:
        ...
        elif 'search wikipedia' in query and 'pan' in query:
            query = query.replace("pan", "")
        ...
        elif 'who is' in query or 'what is a' in query or 'what are' in query and 'pan' in query:
            query = query.replace("pan", "")
        ...
        elif 'internet' in query and 'pan' in query:
            Network()
        
        #Tab operations
        elif 'open tab' in query and 'pan' in query:
            kb.press_and_release('Cmd + T')
            Speak("Tab opened")

        elif 'close tab' in query and 'pan' in query:
            kb.press_and_release('Cmd + W')
            Speak("Tab closed")
        
        elif 'spotlight' in query and 'pan' in query:
            kb.press_and_release('Cmd + Space')
            Speak("Done Sir!")
        
        elif 'incognito' in query and 'pan' in query:
            kb.press_and_release('Cmd + Shift + N')
        
        #delete operations
        elif 'delete' in query and 'pan' in query and 'email' in query:
            Speak("Deleting selected emails")
            kb.press_and_release('delete')
        
        elif 'delete' in query and 'pan' in query and 'file' in query:
            Speak("Deleting selected files")
            kb.press_and_release('Cmd + delete')
        
        elif 'delete' in query and 'pan' in query and 'folder' in query:
            Speak("Deleting selected folders")
            kb.press_and_release('Cmd + delete')
        
        elif 'system status' in query and 'pan' in query:
            SystemInfo()

        elif 'tell me a joke' in query and 'pan' in query:
            Speak(pyjokes.get_joke())
        
        elif 'open google' in query and 'pan' in query:
            webbrowser.open("https://www.google.com")
            playsound(aiVoices + "Jarvis-OnScreen.mp3")
        
        elif 'open facebook' in query and 'pan' in query:
            webbrowser.open("https://www.facebook.com")
            playsound(aiVoices + "Jarvis-OnScreen.mp3")
        
        elif 'instagram' in query and 'pan' in query:
            webbrowser.open("https://www.instagram.com")
            playsound(aiVoices + "Jarvis-OnScreen.mp3")
        
        elif 'open portal' in query and 'pan' in query:
            webbrowser.open("https://blumediaconsultants.com/portal/")
            playsound(aiVoices + "Jarvis-OnScreen.mp3")

        elif 'screenshot' in query and 'pan' in query:
            screenshot()
        
        elif 'open chrome' in query and 'pan' in query:
            OpenApps()
        
        elif 'close chrome' in query and 'pan' in query:
            CloseApps()
        
        elif 'open code' in query and 'pan' in query:
            OpenApps()
        
        elif 'close code' in query and 'pan' in query:
            CloseApps()
        
        elif 'open photoshop' in query and 'pan' in query:
            OpenApps()
        
        elif 'close photoshop' in query and 'pan' in query:
            CloseApps()
        
        elif 'open safari' in query and 'pan' in query:
            OpenApps()
        
        elif 'close safari' in query and 'pan' in query:
            CloseApps()
        
        elif 'open photos' in query and 'pan' in query:
            OpenApps()
        
        elif 'close photos' in query and 'pan' in query:
            CloseApps()
        
        elif 'open email' in query and 'pan' in query:
            OpenApps()
        
        elif 'close email' in query and 'pan' in query:
            CloseApps()
        ...
        elif 'alarm' in query and 'set' in query and 'pan' in query:
        ...
        elif 'to remember' in query and 'pan' in query:
        ...
        elif 'temperature' in query and 'pan' in query:
            Temp()
        
        elif 'how to' in query and 'pan' in query:
        ...
        elif "time" in query and 'pan' in query:
            Time()
        
        elif "date" in query and 'pan' in query:
            Date()
        
        elif "day" in query and 'pan' in query:
            Day()
